...
const apiCall = `https://api.mapbox.com/geocoding/v5/mapbox.places/${process.argv[2]}.json?access_token=pk.eyJ1IjoiYXRoZW1pciIsImEiOiJjazBucWlxMmowMmV4M2xtbG9pbjJ0d215In0.IUxaS4knE4C2byyDL00gOw`
...
const getLocation = async (place) => {
    try {
        let data = await promisifiedRequest({url: apiCall , json: true})
        return({
